      ...
      {sorted.map((entry, i) => {
        ...
        return (
          ...
          >
            ...
            <BuddySprite species={entry.card.species} size={4} animated={false} shiny={entry.card.shiny} eye={entry.card.eye} hat={entry.card.hat} fighterClass={entry.card.class} customSprite={entry.card.customSprite} bodyType={entry.card.bodyType} level={entry.card.level} />
